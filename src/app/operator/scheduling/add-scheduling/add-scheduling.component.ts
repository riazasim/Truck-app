...
export class AddSchedulingComponent implements OnInit, OnDestroy {
    ...
    initConvoyForm(data?: convoyModel): void {
        this.convoyForm = this.fb.group({
            ...
            quantity: this.fb.control(data?.quantity || null,[Validators.required]),
    ...
    initForm(data?: PlanningModel): void {
        this.schedulingForm = this.fb.group({
            routingDetail: this.fb.group({
                ...
                length: this.fb.control(data?.routingDetail?.length || null,[Validators.required]),
                width: this.fb.control(data?.routingDetail?.width || null,[Validators.required]),
                maxDraft: this.fb.control(data?.routingDetail?.maxDraft || null,[Validators.required]),
                arrivalGuage: this.fb.control(data?.routingDetail?.arrivalGuage || null,[Validators.required]),
                maxCapacity: this.fb.control(data?.routingDetail?.maxCapacity || null,[Validators.required]),
                lockType: this.fb.control(data?.routingDetail?.lockType || '',[Validators.required]),
            }),
            convoyDetail: this.fb.control(data?.convoyDetail || [],[Validators.required]),
