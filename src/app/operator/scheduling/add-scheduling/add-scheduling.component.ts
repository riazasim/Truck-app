...
export class AddSchedulingComponent implements OnInit, OnDestroy {
    ...
    initConvoyForm(data?: convoyModel): void {
        this.convoyForm = this.fb.group({
            ...
            pavilion: this.fb.control(data?.pavilion || null),
            enginePower: this.fb.control(data?.enginePower || null),
            lengthOverall: this.fb.control(data?.lengthOverall || null),
            width: this.fb.control(data?.width || null),
            maxDraft: this.fb.control(data?.maxDraft || null),
            maxQuantity: this.fb.control(data?.maxQuantity || null),
    ...
    initForm(data?: PlanningModel): void {
        this.schedulingForm = this.fb.group({
            routingDetail: this.fb.group({
                ...
                zone: this.fb.control(data?.routingDetail?.zone || null),
                ...
                length: this.fb.control(data?.routingDetail?.length || null),
                width: this.fb.control(data?.routingDetail?.width || null),
                maxDraft: this.fb.control(data?.routingDetail?.maxDraft || null),
                arrivalGuage: this.fb.control(data?.routingDetail?.arrivalGuage || null),
                maxCapacity: this.fb.control(data?.routingDetail?.maxCapacity || null),
